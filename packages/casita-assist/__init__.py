...
_CONTROL_PATTERNS = tuple(
    ...
    for pattern in (
        ...
        r"\b(anvil|atlas|casebook|courier|forge|herald|hound|identity|loom|proxmox|vault)\b",
        r"\b(oracle|pixie|sieve|truenas|seaweed|pfsense|loki|prometheus|netbox|thehive|authentik|vaultwarden)\b",
