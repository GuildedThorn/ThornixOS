{ ... }:
{
  networking = {
    ...
    firewall.extraCommands = ''
      iptables -w -A nixos-fw -p tcp -m multiport --dports 22,443,465,587,993 -s 172.16.25.0/24 -j nixos-fw-accept
      iptables -w -A nixos-fw -p tcp -m multiport --dports 22,443,465,587,993 -s 192.168.1.0/24 -j nixos-fw-accept
      iptables -w -A nixos-fw -p tcp -m multiport --dports 22,443,465,587,993 -s 10.10.10.0/24 -j nixos-fw-accept
    '';
  };
}
